...
@*/
void MPE_Errors_call_debugger(char *pgm, char *dbg, char **args)
{
MPI_Errhandler err;
int            i;
...
void MPE_Errors_call_xdbx(char *pgm, char *display)
{
    char **args;
...
void MPE_Errors_call_dbx_in_xterm(char *pgm, char *display)
{
    char **args;
    int  myid, str_len;
...
/* This routine is collective; all processes in MPI_COMM_WORLD must call */
void MPE_Errors_call_gdb_in_xterm(char *pgm, char *display)
{
    char **args;
    int  myid, str_len;
