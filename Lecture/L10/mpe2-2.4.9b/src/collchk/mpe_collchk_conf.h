...
/* mpe_collchk_conf.h.in.  Generated from configure.ac by autoheader.  */
...
#define HAVE_FORTRAN_MPI_DATATYPE_2COMPLEX_IN_C 1
...
#define HAVE_PTR_MPI_DATATYPE 1
